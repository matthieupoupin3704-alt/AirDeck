...
* [ ] **Notification Timing:** Track change notifications can arrive late or chain rapidly when skipping quickly. This seems to be a BlueZ/AVRCP limitation: the phone reports metadata with a delay we cannot control from the Steam Deck side.
